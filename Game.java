    ...
    public static void main(String[] args) {
        ...
        */
        while (!state.finished) {
            ...
            System.out.println("[6]: Would you like to use the phone to call?");
                ...
                case 5:
                    ...
                    try {
                        ...
                        if (state.inventory.contains(item)) {
                            item.use();
                            printSlow(item.use);
                            if (item.action.equals("call")) {
                               System.out.println("Your phone dies before mom is able to pick up");
                               String mother = state.myCallFunction();
                            }
                        }
                        else {
                            printSlow("Unknown item.");
