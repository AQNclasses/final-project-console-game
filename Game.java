    ...
    public static void main(String[] args) {
        ...
        */
        while (!state.finished) {
            ...
            System.out.println("[6]: Check your health");
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        printSlow("You step through the " + door + " door. You realize this room is the " + state.room.name + ".");
                            ...
                            System.err.println("This door is locked, find the correct key to unlock it!");
                        }
                    } catch (Exception e) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    printSlow("Your current health is: ");
                    System.out.print(GameState.getHealth("player"));
                    break;   
